...
const PG_DEV_POSTGRES_URL: &str = "postgres://postgres:password@localhost:5437/postgres";
const PG_DEV_APP_URL: &str = "postgres://app_user:nirvana@localhost:5437/app_db";
